...
namespace Store.Ecommerce.Migrations
{
    ...
    [Migration("20230730043745_update-attribute")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Store.Ecommerce.Catalog.Atrributes.Attribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Store.Ecommerce.Catalog.Atrributes.ProductAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Store.Ecommerce.Catalog.Atrributes.ProductAttributeValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Store.Ecommerce.Catalog.Atrributes.ProductSpecificationAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppProductSpecificationAttributes", (string)null);
                });

            modelBuilder.Entity("Store.Ecommerce.Catalog.Atrributes.SpecificationAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppSpecificationAttributes", (string)null);
                });

            modelBuilder.Entity("Store.Ecommerce.Catalog.Atrributes.SpecificationAttributeOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppSpecificationAttributeOptions", (string)null);
                });

            modelBuilder.Entity("Store.Ecommerce.Catalog.Categories.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Store.Ecommerce.Catalog.Categories.CategorySpecification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CategoryId", "SpecificationAttributeId");

                    b.ToTable("AppCategorySpecifications", (string)null);
                });

            modelBuilder.Entity("Store.Ecommerce.Catalog.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Store.Ecommerce.Catalog.Atrributes.ProductAttribute", b =>
                {
                    b.HasOne("Store.Ecommerce.Catalog.Atrributes.Attribute", "Attribute")
                        .WithMany()
                        .HasForeignKey("AttributeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Store.Ecommerce.Catalog.Products.Product", "Product")
            ...
            modelBuilder.Entity("Store.Ecommerce.Catalog.Atrributes.ProductAttributeValue", b =>
                {
                    b.HasOne("Store.Ecommerce.Catalog.Atrributes.ProductAttribute", "ProductAttribute")
                        .WithOne("ProductAttributeValue")
                        .HasForeignKey("Store.Ecommerce.Catalog.Atrributes.ProductAttributeValue", "ProductAttributeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Store.Ecommerce.Catalog.Atrributes.ProductSpecificationAttribute", b =>
                {
                    ...
                    b.HasOne("Store.Ecommerce.Catalog.Atrributes.SpecificationAttributeOption", "SpecificationAttributeOption")
                        .WithMany("ProductSpecificationAttributes")
            ...
            modelBuilder.Entity("Store.Ecommerce.Catalog.Atrributes.SpecificationAttributeOption", b =>
                {
                    b.HasOne("Store.Ecommerce.Catalog.Atrributes.SpecificationAttribute", "SpecificationAttribute")
            ...
            modelBuilder.Entity("Store.Ecommerce.Catalog.Products.Product", b =>
                {
                    b.HasOne("Store.Ecommerce.Catalog.Categories.Category", "Category")
                        .WithMany("Products")

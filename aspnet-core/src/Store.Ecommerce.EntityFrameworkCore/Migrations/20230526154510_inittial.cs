        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverPicture = table.Column<string>(type: "varchar(250)", maxLength: 250, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    MetaTitle = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ParentId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    TreePath = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ExtraProperties = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ConcurrencyStamp = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppCategorySpecifications", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppSpecificationAttributes", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MetaDescription = table.Column<string>(type: "varchar(250)", maxLength: 250, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MetaKeywords = table.Column<string>(type: "varchar(250)", maxLength: 250, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Description = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ShortDescription = table.Column<string>(type: "varchar(250)", maxLength: 250, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ThumbnailPicture = table.Column<string>(type: "varchar(250)", maxLength: 250, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    IsShippingEnabled = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    IsFreeShipping = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    AdditionalShippingCharge = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppSpecificationAttributeOptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppSpecificationAttributeOptions_AppSpecificationAttributes_~",
                        column: x => x.SpecificationAttributeId,
                        principalTable: "AppSpecificationAttributes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppProductSpecificationAttributes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppProductSpecificationAttributes_AppProducts_ProductId",
                        column: x => x.ProductId,
                        principalTable: "AppProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppProductSpecificationAttributes_AppSpecificationAttributeO~",
                        column: x => x.SpecificationAttributeOptionId,
                        principalTable: "AppSpecificationAttributeOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appcategories_TreePath",
                table: "Appcategories",
                column: "TreePath");

            migrationBuilder.CreateIndex(
                name: "IX_AppCategorySpecifications_CategoryId_SpecificationAttributeId",
                table: "AppCategorySpecifications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppProducts_Name_SKU",
                table: "AppProducts",
                columns: new[] { "Name", "SKU" });

            migrationBuilder.CreateIndex(
                name: "IX_AppProductSpecificationAttributes_ProductId",
                table: "AppProductSpecificationAttributes",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_AppProductSpecificationAttributes_SpecificationAttributeOpti~",
                table: "AppProductSpecificationAttributes",
                column: "SpecificationAttributeOptionId");

            migrationBuilder.CreateIndex(
                name: "IX_AppSpecificationAttributeOptions_SpecificationAttributeId",
                table: "AppSpecificationAttributeOptions",
